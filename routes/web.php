...
Route::prefix('admin')->group(function(){
    ...
    Route::post('add-trip', [TripController::class, 'createNewTrip'])->middleware(['auth'])->name('post-add-trip');
    ...
    Route::post('edit-trip/{trip:slug}', [TripController::class, 'updateTrip'])->middleware(['auth'])->name('update-post');
